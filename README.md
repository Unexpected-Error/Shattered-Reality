...
## Latest Realease 
Download [Shattered_Reality](/Unexpected-Error/Shattered-Reality/releases/latest/download/WindowsClient.zip) alpha to start playing!
...
## Description
Shattered Reality is a WIP firstperson shooter game that uses Steam's multiplayer API for server discovery build on the [Unreal Engine 4](https://www.unrealengine.com/). This current version is alpha and other than the server discovery bits, it is currently a generic FFA shooter where the person with the most kills wins.
